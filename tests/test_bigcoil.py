...
def main():
    ...
    name = 'test_bigcoil'
    ls = 1                  # ls  : length of the sensor coil
    ods = 1000.5            # ods : outer diameter of the sensor coil
    ids = 999.5             # ids : inner diameter of the sensor coil
    lc = 1                  # lc  : length of the magnetic core
    ...
    odw = 1                 # odw : outer diameter of the wire used to wind the sensor including insulation, as this is used to calculate the number of turns.
    odwc= 1                 # odwc : outer diameter of the copper wire cross section only
    pf = 1                  # pf  : The packing factor
    ma = 'Air'              # ma  : The core material (must be defined within the FEMM program)
    force_n = 1             # Set to False if you wish the program to deduce the number of turns based on the provded coil geometry
